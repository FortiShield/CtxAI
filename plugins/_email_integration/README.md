...
Communicate with CtxAI through email inboxes and send replies back over SMTP.
...
- **Description**: Communicate with CtxAI via email. Supports IMAP/Exchange inbox polling with SMTP replies.
