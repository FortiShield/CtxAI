...
Use these CtxAI conventions while reviewing:
...
- For the community index review, fetch the current index from `https://github.com/ctxos/ctx-plugins/releases/download/generated-index/index.json`
