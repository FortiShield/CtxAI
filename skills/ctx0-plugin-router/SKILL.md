...
|---|---|
| Create / build / develop / write a new plugin | Read `/ctx0/skills/ctx0-create-plugin/SKILL.md` |
| Review / audit / validate / check a plugin | Read `/ctx0/skills/ctx0-review-plugin/SKILL.md` |
| Contribute / publish / submit / share to community | Read `/ctx0/skills/ctx0-contribute-plugin/SKILL.md` |
| Install / update / uninstall / remove / browse / scan | Read `/ctx0/skills/ctx0-manage-plugin/SKILL.md` |
| Plugin not working / crashing / missing / debug / troubleshoot | Read `/ctx0/skills/ctx0-debug-plugin/SKILL.md` |
...
If the user says "make a plugin for the community" - start with `ctx0-create-plugin`, then note that `ctx0-contribute-plugin` handles the publishing step after the plugin is built and tested.
...
CtxAI discovers plugins from two roots, in priority order:
...
- Architecture + extension points: `/ctx0/docs/agents/AGENTS.plugins.md`
- Developer guide: `/ctx0/docs/developer/plugins.md`
- Component system: `/ctx0/docs/agents/AGENTS.components.md`
- Modal system: `/ctx0/docs/agents/AGENTS.modals.md`
