...
Reference material for `ctx0-review-plugin`. Read specific sections as needed during the review.
...
def install():
    ...
    # This installs into the CtxAI FRAMEWORK runtime (/opt/venv-ctx0)
...
When submitting to https://github.com/ctxos/ctx-plugins, CI validates:
