---
name: "create-skill"
description: "Wizard for creating new Ctx AI skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills."
version: "1.0.0"
author: "Ctx AI Team"
...
This skill helps you create new Ctx AI skills that follow the SKILL.md standard.
...
mkdir -p /ctx/usr/skills/my-skill/{scripts,templates,docs}
```
...
1. Create skill directory:
   ```bash
   mkdir -p /ctx/usr/skills/my-skill
   ```

2. Create SKILL.md:
   ```bash
   touch /ctx/usr/skills/my-skill/SKILL.md
   ```
...
4. Users can copy to their `/ctx/usr/skills/` directory
