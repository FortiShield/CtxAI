---
name: "create-skill"
description: "Wizard for creating new CtxAI skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills."
version: "1.0.0"
author: "CtxAI Team"
...
This skill helps you create new CtxAI skills that follow the SKILL.md standard.
...
mkdir -p /ctx0/usr/skills/my-skill/{scripts,templates,docs}
```
...
1. Create skill directory:
   ```bash
   mkdir -p /ctx0/usr/skills/my-skill
   ```

2. Create SKILL.md:
   ```bash
   touch /ctx0/usr/skills/my-skill/SKILL.md
   ```
...
4. Users can copy to their `/ctx0/usr/skills/` directory
