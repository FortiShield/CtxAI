...
import ctxai.core.models as models
from ctxai.core.runtime import runtime
from ctxai.integrations.git import git
from ctxai.utils import defer, subagents, whisper
from ctxai.utils.notification import (
    NotificationManager,
    NotificationPriority,
    NotificationType,
)
from ctxai.utils.print_style import PrintStyle
from ctxai.utils.providers import FieldOption as ProvidersFO
from ctxai.utils.providers import get_providers
from ctxai.utils.secrets import get_default_secrets_manager
...
def _apply_settings(previous: Settings | None):
    ...
    if _settings:
        ...
        if not previous or (
            ...
            from ctxai.utils.extension import call_extensions_async
        ...
        if not previous or _settings["mcp_servers"] != previous["mcp_servers"]:
            from ctxai.utils.mcp_handler import MCPConfig
        ...
        if not previous or current_token != previous["mcp_server_token"]:
            ...
            async def update_mcp_token(token: str):
                from ctxai.utils.mcp_server import DynamicMcpProxy
        ...
        if not previous or current_token != previous["mcp_server_token"]:
            ...
            async def update_a2a_token(token: str):
                from ctxai.utils.fasta2a_server import DynamicA2AProxy
