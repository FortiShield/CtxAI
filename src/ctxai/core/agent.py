...
import ctxai.utils.log as Log
from ctxai.core.context import context as context_helper
from ctxai.core.messages import history
from ctxai.utils import (
    dirty_json,
    extension,
    extract_tools,
    files,
...
from ctxai.utils.dirty_json import DirtyJson
from ctxai.utils.errors import (
...
class AgentContext:
    ...
    def get_notification_manager(cls):
        if cls._notification_manager is None:
            from ctxai.utils.notification import NotificationManager  # type: ignore
...
class Agent:
    ...
    async def process_tools(self, msg: str):
        ...
        if tool_request is not None:
            ...
            try:
                import ctxai.utils.mcp_handler as mcp_helper
    ...
    def get_tool(
        ...
        **kwargs,
        ...
        from ctxai.utils.tool import Tool
