...
python -m backend.utils.skills_cli create my-skill-name

# List all available skills
python -m backend.utils.skills_cli list

# Validate a skill
python -m backend.utils.skills_cli validate my-skill-name

# Search skills
python -m backend.utils.skills_cli search "keyword"
```
...
```bash
# Using CLI
python -m backend.utils.skills_cli create my-awesome-skill
...
```bash
# Validate the skill
python -m backend.utils.skills_cli validate my-awesome-skill
...
1. **Validate Structure:**
   ```bash
   python -m backend.utils.skills_cli validate my-skill
   ```
...
2. **Create Your Skill:**
   ```bash
   python -m backend.utils.skills_cli create my-skill
