...
def initialize_agent(override_settings: dict | None = None):
    ...
    # import backend.utils.mcp_handler as mcp_helper
    # import agent as agent_helper
    # import backend.utils.print_style as print_style_helper
...
def initialize_mcp():
    ...
    async def initialize_mcp_async():
        from backend.utils.mcp_handler import initialize_mcp as _initialize_mcp
...
def initialize_job_loop():
    from backend.utils.job_loop import run_loop
