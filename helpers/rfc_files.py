...
def get_subdirectories(relative_path: str, include: Union[str, list[str]] = "*", exclude: Union[str, list[str], None] = None) -> list[str]:
    """
...
def _get_subdirectories_impl(folder_path: str, include: Union[str, list[str]], exclude: Union[str, list[str], None]) -> list[str]:
    """
