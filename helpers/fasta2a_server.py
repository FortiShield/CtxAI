...
class CtxAIWorker(Worker):  # type: ignore[misc]
    """CtxAI implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through CtxAI."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to CtxAI format
            ...
            # Process message through CtxAI (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to CtxAI UserMessage."""
