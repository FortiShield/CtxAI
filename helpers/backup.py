...
class BackupService:
    """
    Core backup and restore service for CtxAI.
    ...
    def __init__(self):
        ...
        self.ctxai_root = files.get_abs_path("")  # Resolved CtxAI root
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes CtxAI project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up CtxAI root path with the current CtxAI root path
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up ctxai root
        ...
        try:
            ...
            with zipfile.ZipFile(temp_file, 'r') as zipf:
                ...
                for archive_path in archive_files:
                    # Archive path is already the correct relative path (e.g., "ctx0/tmp/settings.json")
                    ...
                    # so that patterns like "/home/rafael/ctx0/data/**" can match files correctly
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up ctxai root
