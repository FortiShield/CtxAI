...
def clone_git_project(name: str, git_url: str, git_token: str, data: BasicProjectData):
    """Clone a git repository as a new CTX0 project. Token is used only for cloning via http header."""
    ...
    try:
        ...
        # Check if cloned repo already has .ctx0proj
...
def build_system_prompt_vars(name: str):
    ...
    return {
        ...
        "project_path": files.normalize_ctx0_path(get_project_folder(name)),
