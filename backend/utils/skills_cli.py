...
Usage:
    ...
    python -m backend.utils.skills_cli create <name>     Create a new skill
    python -m backend.utils.skills_cli show <name>       Show skill details
    python -m backend.utils.skills_cli validate <name>   Validate a skill
    python -m backend.utils.skills_cli search <query>    Search skills
"""
